...
class MessageCommands(Scale):
    ...
    async def transcript(self, ctx):
        ...
        def check_message_mention(msgs: dis_snek.Message):
            user_mentions: list = msgs.mention_users
            role_mentions: list = msgs.mention_roles
            channel_mentions: list = msgs.mention_channels
        ...
        f = f'''
            ...
            <body>
                <div class=info>
                    <div class=guild-icon-container><img class=guild-icon src={ctx.guild.icon.url}></div>
                    <div class=metadata>
        ...
        await ctx.channel.send(file=File(io.StringIO(f), 'file.html'))
def setup(bot):
    MessageCommands(bot)
